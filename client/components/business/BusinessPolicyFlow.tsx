...
const businessFlowScenarios: FlowScenario[] = [
  {
    ...
    steps: [
      ...
      },
      {
        ...
        status: "passed",
        details: ["用户部门: IT", "费用申请部门: IT", "结果: 部门匹配"],
        conditions: [
          {
      ...
      },
      {
        ...
        status: "passed",
        details: ["审批流程: 单级审批", "预算检查: 通过", "合规性: 符合要求"],
      },
      {
        id: "decision-1",
        type: "decision",
  ...
  },
  {
    ...
    steps: [
      ...
      },
      {
        ...
        status: "passed",
        details: ["用户负责区域: 华东", "客户所在区域: 华东", "结果: 区域匹配"],
        conditions: [
          {
      ...
      },
      {
        ...
        status: "failed",
        details: ["请求数据: 财务信息", "权限级别: 基础信息", "结果: 权限不足"],
        conditions: [
          {
            attribute: "data_type",
            operator: "equals",
  ...
  },
  {
    ...
    steps: [
      ...
      },
      {
        ...
        status: "failed",
        details: ["用户等级: 2级", "所需等级: 3级以上", "结果: 等级不足"],
        conditions: [
          {
    ...
    <div className="space-y-6">
          ...
          <div className="flex items-center gap-4 mb-4">
            <div className="flex-1">
              <Select
                ...
                onValueChange={(value) => {
                  const scenario = businessFlowScenarios.find(
                    (s) => s.id === value,
                  );
                  if (scenario) {
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>逐步展示访问控制决策的完整过程</CardDescription>
        </CardHeader>
        <CardContent>
          <div className="relative">
            {selectedScenario.steps.map((step, index) => (
              <div key={step.id} className="relative">
                {/* Step Card */}
                <div
                  className={`p-4 border-2 rounded-lg mb-4 transition-all duration-500 ${getStepColor(
                    step.type,
      ...
      <Card>
        ...
        <CardContent>
          <Alert
            className={
              selectedScenario.finalResult === "allow" ? "" : "border-red-200"
            }
          >
            {selectedScenario.finalResult === "allow" ? (
