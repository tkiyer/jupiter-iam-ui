...
export default function BusinessScenarioSimulator() {
  ...
  const evaluateRBAC = (config: SimulationConfig) => {
    ...
    if (
      user.role === "employee" &&
      ["approve", "delete", "configure"].includes(action)
    ) {
            ...
            <Tabs defaultValue="user" className="space-y-4">
              ...
              <TabsContent value="user" className="space-y-4">
                ...
                <div>
                  ...
                  <Select
                    ...
                    onValueChange={(value) =>
                      setConfig((prev) => ({
                        ...prev,
                        user: { ...prev.user, department: value },
                      }))
                    }
                  >
                    <SelectTrigger>
                ...
                <div>
                  <Label htmlFor="clearance-level">
                    安全等级: {config.user.clearanceLevel}
                  </Label>
                  <Slider
                    ...
                    onValueChange={(value) =>
                      setConfig((prev) => ({
                        ...prev,
                        user: { ...prev.user, clearanceLevel: value[0] },
                      }))
                    }
                    max={5}
                    min={1}
                ...
                <div>
                  ...
                  <Select
                    value={config.user.region}
                    onValueChange={(value) =>
                      setConfig((prev) => ({
                        ...prev,
                        user: { ...prev.user, region: value },
                      }))
                    }
                  >
                    <SelectTrigger>
              ...
              <TabsContent value="resource" className="space-y-4">
                ...
                <div>
                  ...
                  <Select
                    value={config.resource.classification}
                    onValueChange={(value) =>
                      setConfig((prev) => ({
                        ...prev,
              ...
              <TabsContent value="context" className="space-y-4">
                <div>
                  ...
                  <Input
                    ...
                    onChange={(e) =>
                      setConfig((prev) => ({
                        ...prev,
                        context: { ...prev.context, time: e.target.value },
                      }))
                    }
                  />
                </div>
                ...
                <div>
                  ...
                  <Select
                    ...
                    onValueChange={(value) =>
                      setConfig((prev) => ({
                        ...prev,
                        context: { ...prev.context, location: value },
                      }))
                    }
                  >
                    <SelectTrigger>
                ...
                <div>
                  ...
                  <Select
                    value={config.context.networkType}
                    onValueChange={(value) =>
                      setConfig((prev) => ({
                        ...prev,
                        context: { ...prev.context, networkType: value },
                      }))
                    }
                  >
                    <SelectTrigger>
                ...
                <div className="flex items-center space-x-2">
                  <Switch
                    ...
                    onCheckedChange={(checked) =>
                      setConfig((prev) => ({
                        ...prev,
                        context: { ...prev.context, emergencyMode: checked },
                      }))
                    }
                  />
          ...
          <CardContent>
            {isSimulating ? (
              ...
              <div className="space-y-4">
                ...
                <Alert
                  className={
                    result.finalDecision === "allow" ? "" : "border-red-200"
                  }
                >
                  ...
                  <AlertDescription>
                    ...
                    <div className="mt-2 text-sm">{result.businessImpact}</div>
                  </AlertDescription>
                </Alert>
