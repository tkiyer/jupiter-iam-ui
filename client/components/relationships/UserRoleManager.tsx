...
import {
  ...
  ValidationResult,
} from "../../../shared/relationship-validator";
...
export default function UserRoleManager({
  ...
  const handleAddAssignment = async () => {
    ...
    const existingAssignment = assignments.find(
      (a) =>
        a.userId === newAssignment.userId && a.roleId === newAssignment.roleId,
    );
  ...
  const handleBulkAssignment = async () => {
    if (
      bulkAssignment.userIds.length === 0 ||
            ...
            if (role) {
              ...
              if (!existingAssignment) {
                newAssignments.push({
                  ...
                  conditions:
                    bulkAssignment.temporaryAccess && bulkAssignment.expiresAt
                      ? [
                          {
          ...
          <Dialog open={isAddDialogOpen} onOpenChange={setIsAddDialogOpen}>
            ...
            <DialogContent className="max-w-md">
              <DialogHeader>
                ...
                <DialogDescription>为用户分配新的角色权限</DialogDescription>
              </DialogHeader>
      ...
      <Dialog open={isEditDialogOpen} onOpenChange={setIsEditDialogOpen}>
        <DialogContent className="max-w-md">
          <DialogHeader>
            ...
            <DialogDescription>修改分配的详细信息和条件</DialogDescription>
          </DialogHeader>
                ...
                <Input
                  ...
                  onChange={(e) =>
                    setEditingAssignment((prev) =>
                      prev
                        ? { ...prev, expiresAt: e.target.value || undefined }
                        : null,
                    )
                  }
                />
      ...
      >
        <DialogContent className="max-w-2xl">
          <DialogHeader>
            ...
            <DialogDescription>为多个用户批量分配角色权限</DialogDescription>
          </DialogHeader>
