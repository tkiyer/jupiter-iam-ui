...
const Console: React.FC = () => {
  ...
  return (
    <div className="space-y-8">
      ...
      {/* Quick System Access */}
      <div>
        <h2 className="text-2xl font-bold text-gray-900 mb-6">Quick System Access</h2>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <Card className="lg:col-span-1">
          ...
          <CardContent className="space-y-4">
            ...
            <div>
              <p className="text-sm font-medium text-gray-700 mb-2">Assigned Roles</p>
        ...
        <Card className="lg:col-span-2">
          <CardHeader>
            ...
            <CardDescription>Your latest system interactions and security events</CardDescription>
          </CardHeader>
          <CardContent>
