      ...
      const mockAlerts: SecurityAlert[] = [
        {
          ...
          description:
            "User Bob Wilson has 5 failed login attempts in the last 10 minutes from IP 203.0.113.1",
          userId: "user789",
          userName: "Bob Wilson",
          timestamp: new Date(Date.now() - 600000).toISOString(),
          status: "open",
        },
        {
          ...
          description:
            "User accessing system from new geographic location (VPN detected)",
          userId: "user456",
          userName: "Jane Smith",
          timestamp: new Date(Date.now() - 1200000).toISOString(),
        ...
        },
        {
          ...
          description:
            "Admin permissions granted to user account outside normal workflow",
          userId: "user123",
          userName: "John Doe",
          timestamp: new Date(Date.now() - 1800000).toISOString(),
          status: "resolved",
            ...
            <CardContent className="p-4">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-xs text-muted-foreground">
                    {metrics.alertsResolved} resolved
                  </p>
                </div>
