...
const businessScenarios: BusinessScenario[] = [
  {
    ...
    exampleCase: {
      ...
      reasoning:
        "RBAC: 有部门经理角色 + ABAC: 金额在权限范围内(5万以下) + 本部门费用",
    },
  },
  {
    ...
    exampleCase: {
      ...
      expectedResult: "allow",
      reasoning:
        "RBAC: 有销售角色 + ABAC: 是客户负责人 + 工作时间 + 有财务数据权限",
    },
  },
  {
    id: "hr-system-access",
    ...
    exampleCase: {
      ...
      context: {
        ...
        targetEmployee: "张三",
        dataType: "salary",
        requestReason: "performance_review",
      },
      expectedResult: "deny",
      reasoning:
        "RBAC: 有部门经理角色但无薪资查看权限 + ABAC: 薪资信息需要HR经理级别",
    },
  },
  {
    ...
    exampleCase: {
      ...
      expectedResult: "allow",
      reasoning:
        "RBAC: 有DevOps权限 + ABAC: 在部署窗口内 + 通过安全检查 + 小版本变更",
    },
  },
  {
              ...
              <Card>
                ...
                <CardContent className="space-y-4">
                  ...
                  <div>
                    ...
                    <ul className="space-y-1">
                      {selectedScenario.abacConditions.map(
                        (condition, index) => (
                          <li
                            key={index}
                            className="text-sm flex items-start gap-2"
                  ...
                  <div>
                    ...
                    <div className="p-4 bg-gray-50 rounded-lg space-y-2">
                      <div className="grid grid-cols-2 gap-2 text-sm">
                        ...
                        <Badge
                          variant={
                            selectedScenario.exampleCase.expectedResult ===
                            "allow"
                              ? "default"
                              : "destructive"
                          }
                      ...
                      <div className="text-sm">
                        ...
                        <pre className="mt-1 text-xs bg-white p-2 rounded">
                          {JSON.stringify(
                            selectedScenario.exampleCase.context,
                            null,
                            2,
                          )}
                        </pre>
                      ...
                      <div className="text-sm">
                        ...
                        <p className="mt-1 text-green-700">
                          {selectedScenario.exampleCase.reasoning}
                        </p>
                      </div>
                    </div>
                  </div>
                      ...
                      <CardContent className="pt-4">
                        <div className="space-y-3">
                          ...
                          <div className="text-xs text-muted-foreground">
                            评估时间: {test.result.evaluationTime} | 测试时间:{" "}
