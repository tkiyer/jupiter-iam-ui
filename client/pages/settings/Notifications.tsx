...
const FeishuLogo: React.FC<{ className?: string }> = ({ className }) => (
  <svg viewBox="0 0 48 48" className={className} aria-hidden>
    ...
    <path
      fill="url(#f1)"
      d="M24 4c11 0 20 9 20 20S35 44 24 44 4 35 4 24 13 4 24 4Z"
    />
...
const Notifications: React.FC = () => {
  ...
  const toggle = (id: MessageTypeId, value: boolean) =>
    ...
    <div className="settings-blue-theme space-y-6">
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Configure delivery channels and defaults
          </CardDescription>
        </CardHeader>
            ...
            {CHANNELS.map(({ id, name, Logo, color, bg }) => (
              <div
                ...
                className={cn(
                  ...
                  enabled[id] ? "ring-2 ring-blue-500" : "",
                )}
              >
          ...
          {[
            {
              ...
              desc: "Notify when multiple login failures occur",
            },
            {
              label: "Permission Changes",
              desc: "Notify when user permissions are modified",
            },
            {
              label: "Policy Violations",
              desc: "Notify when access policies are violated",
            },
            {
              label: "Suspicious Activity",
              desc: "Notify about unusual access patterns",
            },
            {
              label: "System Vulnerabilities",
              desc: "Notify about security vulnerabilities",
            },
          ].map((item, i) => (
        ...
        <CardContent className="space-y-4">
          {[
            ...
            },
            {
              ...
              desc: "Notify about system updates and patches",
              on: false,
            },
            {
              label: "Performance Alerts",
              desc: "Notify about performance issues",
              on: false,
            },
            {
              label: "Backup Status",
              desc: "Notify about backup success/failure",
              on: true,
            },
          ].map((item, i) => (
            <div className="flex items-center justify-between" key={i}>
        ...
        <CardContent className="space-y-4">
          {[
            ...
            },
            {
              ...
              desc: "Notify when user roles are assigned/removed",
            },
            {
              label: "Account Deactivation",
              desc: "Notify when user accounts are deactivated",
            },
            {
              label: "Access Requests",
              desc: "Notify about pending access requests",
            },
          ].map((item, i) => (
            <div className="flex items-center justify-between" key={i}>
              <div className="space-y-0.5">
      ...
      <div className="grid grid-cols-2 gap-4">
        <div className="flex items-center justify-between col-span-2">
          ...
          <Switch
            checked={cfg.desktop}
            onCheckedChange={(v) =>
              onChange((p) => ({ ...p, inapp: { ...p.inapp, desktop: v } }))
            }
          />
        </div>
        <div className="flex items-center justify-between col-span-2">
          ...
          <Switch
            checked={cfg.sound}
            onCheckedChange={(v) =>
              onChange((p) => ({ ...p, inapp: { ...p.inapp, sound: v } }))
            }
          />
        </div>
      </div>
      ...
      <div className="grid grid-cols-2 gap-4">
        <div className="space-y-2">
          ...
          <Input
            ...
            onChange={(e) =>
              onChange((p) => ({
                ...p,
                email: { ...p.email, fromAddress: e.target.value },
              }))
            }
        ...
        <div className="space-y-2">
          ...
          <Input
            ...
            onChange={(e) =>
              onChange((p) => ({
                ...p,
                email: { ...p.email, senderName: e.target.value },
              }))
            }
            placeholder="IAM Console"
          />
        </div>
        <div className="space-y-2">
        ...
        <div className="space-y-2">
          ...
          <Input
            ...
            onChange={(e) =>
              onChange((p) => ({
                ...p,
                email: { ...p.email, smtpPort: e.target.value },
              }))
            }
            placeholder="587"
          />
        ...
        <div className="space-y-2">
          ...
          <Select
            ...
            onValueChange={(v: "none" | "ssl_tls" | "starttls") =>
              onChange((p) => ({ ...p, email: { ...p.email, encryption: v } }))
            }
          >
            <SelectTrigger>
              <SelectValue />
        ...
        <div className="flex items-center justify-between col-span-2">
          <div className="space-y-0.5">
            ...
            <p className="text-sm text-gray-500">
              Use username/password for SMTP
            </p>
          </div>
          <Switch
        ...
        <div className="space-y-2">
          ...
          <Input
            disabled={!cfg.authRequired}
            value={cfg.username}
            onChange={(e) =>
              onChange((p) => ({
                ...p,
                email: { ...p.email, username: e.target.value },
              }))
            }
        ...
        <div className="space-y-2">
          ...
          <Input
            ...
            onChange={(e) =>
              onChange((p) => ({
                ...p,
                email: { ...p.email, password: e.target.value },
              }))
            }
            placeholder="••••••••"
          />
      ...
      <div className="grid grid-cols-2 gap-4">
        <div className="space-y-2">
          ...
          <Input
            ...
            onChange={(e) =>
              onChange((p) => ({
                ...p,
                sms: { ...p.sms, phone: e.target.value },
              }))
            }
        ...
        <div className="space-y-2">
          ...
          <Select
            value={cfg.provider}
            onValueChange={(v) =>
              onChange((p) => ({ ...p, sms: { ...p.sms, provider: v } }))
            }
          >
            <SelectTrigger>
        ...
        <div className="space-y-2 col-span-2">
          ...
          <Input
            ...
            onChange={(e) =>
              onChange((p) => ({
                ...p,
                feishu: { ...p.feishu, webhook: e.target.value },
              }))
            }
        ...
        <div className="space-y-2 col-span-2">
          ...
          <Input
            ...
            onChange={(e) =>
              onChange((p) => ({
                ...p,
                feishu: { ...p.feishu, secret: e.target.value },
              }))
            }
      ...
      <div className="space-y-2">
        ...
        <Input
          ...
          onChange={(e) =>
            onChange((p) => ({
              ...p,
              wecom: { ...p.wecom, webhook: e.target.value },
            }))
          }
        ...
        <div className="space-y-2 col-span-2">
          ...
          <Input
            ...
            onChange={(e) =>
              onChange((p) => ({
                ...p,
                dingtalk: { ...p.dingtalk, webhook: e.target.value },
              }))
            }
        ...
        <div className="space-y-2 col-span-2">
          ...
          <Input
            ...
            onChange={(e) =>
              onChange((p) => ({
                ...p,
                dingtalk: { ...p.dingtalk, secret: e.target.value },
              }))
            }
            placeholder="Your signing secret"
          />
    ...
    <div className="grid grid-cols-2 gap-4">
      <div className="space-y-2 col-span-2">
        ...
        <Input
          ...
          placeholder="https://api.your-service.com/notify"
        />
      </div>
      <div className="space-y-2">
        <Label>Method</Label>
        <Select
          value={cfg.method}
          onValueChange={(v: "POST" | "GET") =>
            onChange((p) => ({ ...p, webhook: { ...p.webhook, method: v } }))
          }
        >
          <SelectTrigger>
            <SelectValue />
      ...
      <div className="space-y-2">
        ...
        <Input
          ...
          onChange={(e) =>
            onChange((p) => ({
              ...p,
              webhook: { ...p.webhook, headers: e.target.value },
            }))
          }
